...
def run_dlt_pipeline(bucket_name: str, file_format: str,gcp_credentials_path: str,  sheet_name: str = "Sheet1"):
    ...
    #source credentials https://dlthub.com/docs/general-usage/credentials/setup#default-layout-without-sections
    # os.environ["SOURCES__CREDENTIALS__CLIENT_EMAIL"] = creds2['client_email']
    # os.environ["SOURCES__CREDENTIALS__PRIVATE_KEY"] = creds2['private_key']
    # os.environ["SOURCES__CREDENTIALS__PROJECT_ID"] = creds2['project_id']

    #u can use this for both source and destination and won't need the gcp_credentials for destination
    # os.environ["CREDENTIALS__CLIENT_EMAIL"] = creds2['client_email']
    # os.environ["CREDENTIALS__PRIVATE_KEY"] = creds2['private_key']
    # os.environ["CREDENTIALS__PROJECT_ID"] = creds2['project_id']

    
    # we use gcp_credentials for both source and destination
